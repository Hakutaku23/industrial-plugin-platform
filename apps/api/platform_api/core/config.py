...
def _apply_env_overrides(config: dict[str, Any]) -> dict[str, Any]:
    ...
    mapping = [
        ...
        ('PLATFORM_SCHEDULER_MODE', ('scheduler', 'mode'), _env_str('PLATFORM_SCHEDULER_MODE')),
        ...
        ('PLATFORM_RUNNER_MAX_STDOUT_BYTES', ('runner', 'max_stdout_bytes'), _env_int('PLATFORM_RUNNER_MAX_STDOUT_BYTES')),
        ('PLATFORM_RUNNER_MAX_STDERR_BYTES', ('runner', 'max_stderr_bytes'), _env_int('PLATFORM_RUNNER_MAX_STDERR_BYTES')),
        ('PLATFORM_RUNNER_MAX_OUTPUT_JSON_BYTES', ('runner', 'max_output_json_bytes'), _env_int('PLATFORM_RUNNER_MAX_OUTPUT_JSON_BYTES')),
        ('PLATFORM_RUNNER_MAX_WORKDIR_TOTAL_BYTES', ('runner', 'max_workdir_total_bytes'), _env_int('PLATFORM_RUNNER_MAX_WORKDIR_TOTAL_BYTES')),
        ('PLATFORM_RUNNER_ALLOW_SUBPROCESS_DEFAULT', ('runner', 'allow_subprocess_default'), _env_bool('PLATFORM_RUNNER_ALLOW_SUBPROCESS_DEFAULT')),
        ('PLATFORM_RUNNER_ALLOW_NETWORK_DEFAULT', ('runner', 'allow_network_default'), _env_bool('PLATFORM_RUNNER_ALLOW_NETWORK_DEFAULT')),
